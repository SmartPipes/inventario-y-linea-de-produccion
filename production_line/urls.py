...
from .views import FactoryViewSet, PhaseViewSet, ProductionLineViewSet, ProductionPhaseViewSet, ProductionOrderViewSet, ProductionOrderDetailViewSet, ProductionOrderPhaseViewSet, FactoryManagerViewSet, ProductionOrderWarehouseRetrievalDetailViewSet
...
router.register(r'ProductionOrderWarehouseRetrievalDetail', ProductionOrderWarehouseRetrievalDetailViewSet)
