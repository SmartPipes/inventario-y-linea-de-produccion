...
const NavBarFilters = ({ applyFilters, currentPage, totalPages, setCurrentPage, searchPlaceholder = "Buscar...", filters = ['Carts', 'Sales', 'Payments', 'Cart Details', 'Sale Details'], onSearchChange }) => {
