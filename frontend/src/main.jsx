...
import NewItemPage from './components/pages/inventory/NewItemPage.jsx'; // Importa NewItemPage
...
const router = createBrowserRouter([{
  ...
  children: [
    ...
    { path: "inventory/new-item", element: <NewItemPage /> }, // Añade la ruta para NewItemPage
